...
export { default as GraohSquareFilled } from "./graph-square-filled.svg";
...
export { default as CalendarBottomTabIconFilled } from "./calendar-bottom-tab-filled.svg";
...
export { default as VerticalDots } from "./vertical-dots.svg";
